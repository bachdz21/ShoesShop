    ...
    <body>
        ...
        <script>
                            ...
                            $('#fileInput').change(function () {
                                ...
                                // Debug: Kiểm tra xem sự kiện change có được kích hoạt không
                                console.log("File input changed. Selected files: " + files);

                                // Thêm file mới vào danh sách
                                selectedFiles = selectedFiles.concat(files);

                                // Debug: Kiểm tra danh sách selectedFiles
                            ...
                            function updateFilePreview() {
                                ...
                                // Debug: Kiểm tra số lượng file trong selectedFiles
                                ...
                                if (selectedFiles.length > 0) {
                                    ...
                                    selectedFiles.forEach(function (file, index) {
                                        ...
                                        // Debug: Kiểm tra từng file được thêm vào preview
                                    ...
                                    document.querySelectorAll(".remove-file").forEach(function (button) {
                                        button.addEventListener("click", function () {
                                            ...
                                            updateFilePreview(); // Cập nhật lại preview
                                            adjustChatBodyHeight(); // Cập nhật chiều cao chat_body
                                        });
                                    });
                                } else {
                                    previewContainer.style.display = "none";
                                }
                                adjustChatBodyHeight(); // Cập nhật chiều cao chat_body sau khi preview thay đổi
                            }

                            // Tự động điều chỉnh chiều cao textarea và chat_body
                            const textarea = document.getElementById("msg");
                            ...
                            // Điều chỉnh chiều cao chat_body dựa trên chiều cao fab_field
