...
<html lang="vi">
    ...
    <head>
        ...
        <style>
            ...
            .table-container {
                max-height: 365px; /* Giới hạn chiều cao của bảng */
                            ...
                            <div class="bg-secondary rounded h-100 p-4">
                                <div style="display: flex">
                                    ...
                                    <a style="position: absolute;
                                       left: 435px;
                                       top: 108px;" href="addProduct.jsp" class="product-add-link">Thêm Sản Phẩm</a>
                                       
                                    <a style="position: absolute;
                                       left: 1635px;
                                       top: 108px;" href="trash" class="product-add-link">Sản Phẩm Đã Xóa</a>
                                </div>
