    ...
    <body>
        ...
        <script>
            ...
            var passwordPattern = /^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$/;
                if (!passwordPattern.test(newPassword)) {
                    alert("Mật khẩu mới cần có ít nhất 6 ký tự, bao gồm ít nhất 1 chữ cái, 1 chữ số và có thể chứa ký tự đặc biệt.");
                    return false; // Không cho phép gửi form
                }
        ...
        <script>
            function validateProfileForm() {
                // Lấy giá trị các trường nhập liệu và loại bỏ khoảng trắng 2 bên
                ...
                // Kiểm tra xem các trường có bị để trống sau khi trim không
                if (fullName.value === "") {
